      ...
      <div className="container mx-auto py-16 px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              TransparaTech is dedicated to making technology transparent and accessible. 
              We build solutions that empower businesses through clarity and innovation.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="bg-gray-700 hover:bg-blue-600 p-2 rounded-full text-white transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-300">Data Analytics</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-300">Cloud Solutions</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-300">Cybersecurity</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-300">IT Consulting</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-300">News & Blog</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-300">Cookies Policy</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-300">Disclaimer</a></li>
        ...
        <div className="border-t border-gray-700 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} TransparaTech. All rights reserved.
          </p>
