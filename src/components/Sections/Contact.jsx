        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-xl mx-auto">
              ...
              Reach out to us and experience our transparent approach firsthand.
            </p>
          </div>
              ...
              <div className="bg-gray-50 p-8 rounded-xl shadow-md">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@transparatech.com</p>
                    </div>
                  </div>
                ...
                <div className="mt-8 pt-8 border-t border-gray-200">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="bg-blue-100 p-2 rounded-full text-blue-600 hover:bg-blue-200 transition-colors duration-300">
